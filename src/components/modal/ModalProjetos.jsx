      ...
      {Object.keys(repo).map((key) => (
        <>
          {(repo[key].has_pages && repo[key].visibility === "public" && repo[key].name !== "my-portfolio") &&
            <div key={key} className='block lg:flex lg:items-center lg:justify-between my-8 rounded-lg shadow-xl mx-10 w-3/4 '>
              {tamanhoTela >= 'medio' ?
                (
                  <>
                    <img
                      className='rounded-lg lg:w-1/2 w-full lg:h-72'
